...
const ReportIncomePerPerson = () => {
  ...
  const renderTable = () => {
    ...
    // Estructura para mostrar los datos (filas de 1-2, 3-5, 6-10, 11-15 personas, y total)
    const data = [
      { label: "1-2 personas", values: meses.map(mes => ingresos[mes]["1-2"]) },
      { label: "3-5 personas", values: meses.map(mes => ingresos[mes]["3-5"]) },
      { label: "6-10 personas", values: meses.map(mes => ingresos[mes]["6-10"]) },
      { label: "11-15 personas", values: meses.map(mes => ingresos[mes]["11-15"]) },
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        <thead>
          <tr style={{ backgroundColor: "#f4f4f4", textAlign: "center" }}>
            <th style={headerStyle}>Personas</th>
            {meses.map((mes) => (
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <h2 style={{ textAlign: "center" }}>Reporte de Ingresos por Persona</h2>
...
export default ReportIncomePerPerson;
